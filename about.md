...
我一开始认为**Linux**命令行(**bash**)类似与**Windows**的**DOS**, 只是一个极大的误解, 最终可能导致我放弃**Linux**.  
...
2012-05-01这一天, 我失业了, 我安装了最新版的Ubuntu 12.04系统, 并且使用Ubuntu作为默认启动系统.  
我还留着**Windows XP**的IE6上网上银行, 因此没有格式化C盘.  
